    ...
    public String generarResumen(Solicitud solicitud) {
        ...
        try {
            ...
            if (response.getBody() == null || response.getBody().get("candidates") == null) {
                throw new RuntimeException("Respuesta inválida de la IA");
            }
            ...
            System.err.println("Error IA generarResumen: " + e.getMessage());

            // fallback con datos reales
            return fallback.generarResumenConDatos(solicitud, e);
        }
    }
